angular
	...
	.controller('LoginCtrl', function($scope, $rootScope, $state, $ionicPlatform, $cordovaFacebook, $cordovaProgress, $cordovaDialogs, $ionicHistory, $localStorage, User, AppConfig){
				...
				if(!response.authResponse){
					...
					Parse.FacebookUtils
						...
						.then(function(){
							...
							$rootScope.user.save('settings', {mobile: $rootScope.settings});
				...
				if(!form.$invalid){
					...
					User
						...
						.then(function(){
							...
							switch(e.code){
							case 101: e.message = 'Usuario y contrasena invalidos'; break;
							}
							$cordovaProgress.hide();
